...
This (overly documented) python script reads in the page http://iba-world.com/iba-cocktails/
and prints out the list of recipies found on the page.
...
\~/workspace/python/drink parser  python parser.py  >> readme.md
Traceback (most recent call last):
  File "parser.py", line 42, in <module>
    print " *", ingredient.text
UnicodeEncodeError: 'ascii' codec can't encode character u'\xe9' in position 7: ordinal not in range(128)
\~/workspace/python/drink parser  python parser.py  >> out.txt
Traceback (most recent call last):
  File "parser.py", line 42, in <module>
    print " *", ingredient.text
UnicodeEncodeError: 'ascii' codec can't encode character u'\xe9' in position 7: ordinal not in range(128)
\~/workspace/python/drink parser  python parser.py
ALEXANDER
 * 3 cl Cognac
 * 3 cl Créme de Cacao (brown)
 * 3 cl Fresh cream
